/****************************************************************************
 * boards/arm/stm32h7/stm32h7b3i-dk/include/board.h
 *
...
#ifndef __BOARDS_ARM_STM32H7_STM32H7B3I_DK_INCLUDE_BOARD_H
#define __BOARDS_ARM_STM32H7_STM32H7B3I_DK_INCLUDE_BOARD_H
...
/* The STM32H7B3I-DK board provides the following clock sources:
 *
 *   X2:  24 MHz HSE crystal oscillator
 ...
 *   LSI: 32 KHz RC
 *   HSE: 24 MHz from on-board crystal
 *   LSE: 32.768 kHz
 */
 ...
 *
 *   PLL1_VCO = (24,000,000 / 6) * 140 = 560 MHz
 *
...
#define STM32_PLLCFG_PLL1N       RCC_PLL1DIVR_N1(140)
#define STM32_PLLCFG_PLL1P       RCC_PLL1DIVR_P1(2)
#define STM32_PLLCFG_PLL1Q       RCC_PLL1DIVR_Q1(4)
#define STM32_PLLCFG_PLL1R       RCC_PLL1DIVR_R1(8)

#define STM32_VCO1_FREQUENCY     ((STM32_HSE_FREQUENCY / 6) * 140)
...
#define STM32_PLLCFG_PLL2N       RCC_PLL2DIVR_N2(140)
#define STM32_PLLCFG_PLL2P       RCC_PLL2DIVR_P2(2)
#define STM32_PLLCFG_PLL2Q       0
#define STM32_PLLCFG_PLL2R       0

#define STM32_VCO2_FREQUENCY     ((STM32_HSE_FREQUENCY / 6) * 140)
...
/* AHB clock (HCLK) is SYSCLK/2 (140 MHz)
 ...
 *  (VOS0 level)   140 MHz    6
 *  ------------ ---------- -----------
 *
 * STM32CubeH7 configures the STM32H7B3I-DK 280 MHz clock tree with
 * PWR scale 0 and FLASH latency 6.
 */
...
/* The STM32H7B3I-DK board has two user LEDs:
 *   LD2 (Blue)  connected to PG2
 *   LD3 (Red)   connected to PG11
 */
...
#define LED_ASSERTION      6 /* An assertion failed      N/C    GLOW  */
#define LED_PANIC          7 /* The system has crashed   OFF    Blink */
#define LED_IDLE           8 /* MCU is in sleep mode     ON     OFF   */

/* Button definitions *******************************************************/

/* The STM32H7B3I-DK supports one button:  User button connected to PC13.
...
/* USART1 (Virtual Console via ST-LINK) */
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_STM32H7_STM32H7B3I_DK_INCLUDE_BOARD_H */
